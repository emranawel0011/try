...
let todos = [
  ...
  { id: 2, text: "Practice fetch + async/await", completed: false, saved: true },
  { id: 3, text: "Understand callback functions", completed: false, saved: false },
  { id: 4, text: "Style the todo list with CSS", completed: true, saved: false },
  ...
  { id: 8, text: "Try the filter buttons (All/Active/Completed/Saved)", completed: false, saved: false },
  { id: 9, text: "Read dom.md", completed: true, saved: false },
  { id: 10, text: "Read callbacks.md", completed: true, saved: false },
  { id: 11, text: "Read api.md", completed: false, saved: true },
  { id: 12, text: "Read app.md", completed: false, saved: false },
  { id: 13, text: "Debounce the search input", completed: false, saved: false },
  { id: 14, text: "Explain event delegation to a classmate", completed: false, saved: false },
  { id: 15, text: "Explain async/await to a classmate", completed: false, saved: false },
  { id: 16, text: "Add a 'Clear completed' button", completed: false, saved: false },
  { id: 17, text: "Handle a failed fetch gracefully", completed: false, saved: false },
  { id: 18, text: "Push the project to GitHub", completed: false, saved: false },
];
let nextId = 19;
