 ...
 * invocation, since Vercel's filesystem is read-only and can't hold a
...
let cached = global._pawhavenMongoose;
if (!cached) {
  cached = global._pawhavenMongoose = { conn: null, promise: null };
}
